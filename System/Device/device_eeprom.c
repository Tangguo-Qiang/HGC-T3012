...
#define WP_ACT        GPIO_SetBits(GPIOB, GPIO_Pin_5)//GPIOB->BSRR = GPIO_Pin_5  //PbOut(6)=1 
#define WP_OFF        GPIO_ResetBits(GPIOB, GPIO_Pin_5)//GPIOB->BRR  = GPIO_Pin_5  //PbOut(6)=0   

#define SCL_H        GPIOB->BSRR = GPIO_Pin_6  //PbOut(6)=1 
#define SCL_L        GPIOB->BRR  = GPIO_Pin_6  //PbOut(6)=0   
    
#define SDA_H        GPIOB->BSRR = GPIO_Pin_7  //PbOut(7)=1  
#define SDA_L        GPIOB->BRR  = GPIO_Pin_7 //PbOut(7)=0   

#define SCL_read     GPIOB->IDR  & GPIO_Pin_6  //PbIn(6)  
#define SDA_read     GPIOB->IDR  & GPIO_Pin_7  //PbIn(7)  
...
void InitE2prom(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;  
	GPIO_InitStructure.GPIO_Mode =GPIO_Mode_Out_PP;//GPIO_Mode_IN_FLOATING;//GPIO_Mode_IPU;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
  GPIO_Init(GPIOB, &GPIO_InitStructure);
	WP_ACT;
