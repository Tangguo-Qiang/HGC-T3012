...
#define SIZEOF_USEDTIMER    (sizeof(App.Data.UsedHours))									//16 bytes
#define SIZEOF_SYSPARA      (sizeof(App.Data.SysCtrlPara))									//16 bytes
#define SIZEOF_FILTERTIMER  (sizeof(App.Data.FilterTimerHour))		//12 bytes
#define SIZEOF_FILTERLIMIT  (sizeof(App.Data.FilterHourLimit))		//4 bytes
#define SIZEOF_ENVPARA  		(sizeof(App.Data.SysCtrlLine))		//180 bytes
#define SIZEOF_WEEKTIMER  	(sizeof(App.Data.WeekTimerMode))		
#define SIZEOF_WORKDAYMODE  (sizeof(App.Data.DayTimerMode.WorkDayTimer))		
#define SIZEOF_WEEKENDMODE  (sizeof(App.Data.DayTimerMode.WeekendTimer))		
#define SIZEOF_HOLIDAYMODE  (sizeof(App.Data.DayTimerMode.HolidayTimer))		
#define SIZEOF_PARTYMODE  	(sizeof(App.Data.DayTimerMode.OfficeTimer))		
#define SIZEOF_ENERGYMODE   (sizeof(App.Data.DayTimerMode.EnergyTimer))		



#define EEPROM_ADDRESS_START   				0x00		//180 bytes
