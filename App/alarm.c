...
/**
  ...
  * @retval None
  */
TestStatus AlarmStart(void)
{
	DayTimersTypedef* pdaytimer= &(App.Data.DayTimerMode.WorkDayTimer);
	SysTimerTypedef* ptimer=&(pdaytimer->Timer0);
	byte *timermode= (byte*)&App.Data.WeekTimerMode.MondayTimer;
